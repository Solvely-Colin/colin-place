...
- The layout is the inside as a walkable isometric room. Pick a room size (5-9 tiles each way), a floor and wall colour that match the palette, and place 4-7 objects from the allowed kinds at distinct integer tile positions inside the room (0..w-1, 0..d-1), leaving the front centre free for the entrance. Every object is a thing that belongs in THIS building: choose kinds that fit the idea (a telescope in an observatory, a cauldron in a potion shop, a terminal in a lab), give each a label and a playful, specific note the visitor reads when they walk up. The keeper is the character who runs the place: give them a fitting name and one in-character greeting line.
